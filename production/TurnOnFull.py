...
if sigOrBack == 1:
    ...
    f_out_name = 'sig_ntuple_turnon.root'
elif sigOrBack == 0:
    ...
    f_out_name = 'back_ntuple_turnon.root'
else:
...
for event in t:
    ...
    # Found no valid TOBs, so move to he next event
    ...
    tob_phi[0] = max_et_tob.phi()
    
    run2_et[0] = max_et_tob.ppmTauClus()
